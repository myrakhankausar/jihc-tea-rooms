// lib/screens/boys_rooms_screen.dart
...
class BoysRoomsScreen extends StatelessWidget {
  final UserModel userModel;

  const BoysRoomsScreen({super.key, required this.userModel});

  @override
  Widget build(BuildContext context) {
    const rooms = AppConstants.boysRooms;
    return Scaffold(
      appBar: AppBar(title: const Text("Boys' Tea Rooms")),
